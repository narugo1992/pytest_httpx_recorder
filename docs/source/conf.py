...
modnames = [mname for mname in sys.modules if mname.startswith('pytest_httpx_recorder')]
...
from pytest_httpx_recorder.config.meta import __TITLE__, __AUTHOR__, __VERSION__
